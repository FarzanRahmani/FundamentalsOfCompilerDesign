...
public class AssignmentStatementParser extends Parser {
	...
	public static final int
		...
		T__31=32, T__32=33, INT=34, FLOAT=35, String=36, ID=37, ARRAY_TYPE=38, 
		INT_ARRAY=39, FLOAT_ARRAY=40, STRING_ARRAY=41, WS=42, COMMENT=43, NEWLINE=44, 
		RELOP=45;
	public static final int
	...
	public final CompoundstContext compoundst() throws RecognitionException {
		...
		try {
			...
			do {
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
			} while ( (((_la) & ~0x3f) == 0 && ((1L << _la) & 137439236736L) != 0) );
			setState(108);
			match(T__7);
			}
		}
