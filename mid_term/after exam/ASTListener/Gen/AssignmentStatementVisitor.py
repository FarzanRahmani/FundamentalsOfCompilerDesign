...
class AssignmentStatementVisitor(ParseTreeVisitor):
    ...
    # Visit a parse tree produced by AssignmentStatementParser#ternaryoperator.
    def visitTernaryoperator(self, ctx:AssignmentStatementParser.TernaryoperatorContext):
        return self.visitChildren(ctx)
    ...
    # Visit a parse tree produced by AssignmentStatementParser#assign_expr.
    def visitAssign_expr(self, ctx:AssignmentStatementParser.Assign_exprContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by AssignmentStatementParser#assign_ternaryoperator.
    def visitAssign_ternaryoperator(self, ctx:AssignmentStatementParser.Assign_ternaryoperatorContext):
        return self.visitChildren(ctx)
