...
if __name__ == '__main__':
    ...
    argparser.add_argument(
        '-n', '--file',
        help = 'Input source', default=r'ternaryOp.txt')
        # help = 'Input source', default=r'input.txt')
        # help = 'Input source', default = r'for.txt')
        # help = 'Input source', default = r'while.txt')
        # help = 'Input source', default = r'switch.txt')
        # help = 'Input source', default = r'typeChecking.txt')
