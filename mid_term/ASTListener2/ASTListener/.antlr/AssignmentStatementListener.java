...
public interface AssignmentStatementListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link AssignmentStatementParser#ternaryoperator}.
	 * @param ctx the parse tree
	 */
	void enterTernaryoperator(AssignmentStatementParser.TernaryoperatorContext ctx);
	/**
	 * Exit a parse tree produced by {@link AssignmentStatementParser#ternaryoperator}.
	 * @param ctx the parse tree
	 */
	void exitTernaryoperator(AssignmentStatementParser.TernaryoperatorContext ctx);
	/**
	 ...
	 * labeled alternative in {@link AssignmentStatementParser#assign}.
	 * @param ctx the parse tree
	 */
	void enterAssign_expr(AssignmentStatementParser.Assign_exprContext ctx);
	/**
	 * Exit a parse tree produced by the {@code assign_expr}
	 * labeled alternative in {@link AssignmentStatementParser#assign}.
	 * @param ctx the parse tree
	 */
	void exitAssign_expr(AssignmentStatementParser.Assign_exprContext ctx);
	/**
	 * Enter a parse tree produced by the {@code assign_ternaryoperator}
	 * labeled alternative in {@link AssignmentStatementParser#assign}.
	 * @param ctx the parse tree
	 */
	void enterAssign_ternaryoperator(AssignmentStatementParser.Assign_ternaryoperatorContext ctx);
	/**
	 * Exit a parse tree produced by the {@code assign_ternaryoperator}
	 * labeled alternative in {@link AssignmentStatementParser#assign}.
	 * @param ctx the parse tree
	 */
	void exitAssign_ternaryoperator(AssignmentStatementParser.Assign_ternaryoperatorContext ctx);
	/**
