...
class AssignmentStatementListener(ParseTreeListener):
    ...
    # Enter a parse tree produced by AssignmentStatementParser#ternaryoperator.
    def enterTernaryoperator(self, ctx:AssignmentStatementParser.TernaryoperatorContext):
        pass
    ...
    # Enter a parse tree produced by AssignmentStatementParser#assign_expr.
    def enterAssign_expr(self, ctx:AssignmentStatementParser.Assign_exprContext):
        pass
    ...
    # Enter a parse tree produced by AssignmentStatementParser#assign_ternaryoperator.
    def enterAssign_ternaryoperator(self, ctx:AssignmentStatementParser.Assign_ternaryoperatorContext):
        pass
