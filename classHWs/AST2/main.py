...
def main(args):
    ...
    draw_if_statement(g=ast_generator.g)
    # draw_assignment_statement(g=ast_generator.g)
    print("\nFinished")



def draw_if_statement(g: nx.DiGraph = None):
    """
    ...
    # # # Increase the node_size value to make the nodes larger
    # nx.draw_networkx_nodes(g, custom_pos, node_size=500, node_color='blue', node_shape="s")
...
def draw_assignment_statement(g: nx.DiGraph = None):
    """
...
if __name__ == '__main__':
    ...
    # argparser.add_argument(
    #     '-n', '--file',
    #     help='Input source', default=r'assignment_input.txt')

    # argparser.add_argument(
    #     '-n', '--file',
    #     help='Input source', default=r'while_input.txt')

    # argparser.add_argument(
    #     '-n', '--file',
    #     help='Input source', default=r'for_input.txt')
