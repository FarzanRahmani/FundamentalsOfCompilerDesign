# Generated from E:/uni/7th term/fundamentals of compiler design/classHWs/AST2/AssignmentStatement.g4 by ANTLR 4.13.1
# encoding: utf-8
from antlr4 import *
...
def serializedATN():
    return [
        ...
        1,5,1,5,1,5,1,5,1,6,1,6,1,6,1,6,1,6,4,6,68,8,6,11,6,12,6,69,1,6,
        ...
        1,0,0,0,10,58,1,0,0,0,12,62,1,0,0,0,14,73,1,0,0,0,16,82,1,0,0,0,
        18,87,1,0,0,0,20,104,1,0,0,0,22,125,1,0,0,0,24,129,1,0,0,0,26,134,
        1,0,0,0,28,29,3,2,1,0,29,30,5,0,0,1,30,1,1,0,0,0,31,32,3,12,6,0,
        ...
        45,3,10,5,0,41,45,3,12,6,0,42,45,3,14,7,0,43,45,3,16,8,0,44,39,1,
        0,0,0,44,40,1,0,0,0,44,41,1,0,0,0,44,42,1,0,0,0,44,43,1,0,0,0,45,
        5,1,0,0,0,46,47,5,1,0,0,47,48,3,8,4,0,48,49,5,2,0,0,49,52,3,4,2,
        0,50,51,5,3,0,0,51,53,3,4,2,0,52,50,1,0,0,0,52,53,1,0,0,0,53,7,1,
        0,0,0,54,55,3,18,9,0,55,56,5,4,0,0,56,57,3,18,9,0,57,9,1,0,0,0,58,
        59,5,21,0,0,59,60,5,5,0,0,60,61,3,18,9,0,61,11,1,0,0,0,62,63,5,6,
        0,0,63,67,5,27,0,0,64,65,3,4,2,0,65,66,5,27,0,0,66,68,1,0,0,0,67,
        64,1,0,0,0,68,69,1,0,0,0,69,67,1,0,0,0,69,70,1,0,0,0,70,71,1,0,0,
        0,71,72,5,7,0,0,72,13,1,0,0,0,73,74,5,8,0,0,74,75,5,21,0,0,75,76,
        5,5,0,0,76,77,3,18,9,0,77,78,5,9,0,0,78,79,3,18,9,0,79,80,5,10,0,
        0,80,81,3,4,2,0,81,15,1,0,0,0,82,83,5,11,0,0,83,84,3,8,4,0,84,85,
        5,10,0,0,85,86,3,4,2,0,86,17,1,0,0,0,87,88,6,9,-1,0,88,89,3,20,10,
        0,89,101,1,0,0,0,90,91,10,4,0,0,91,92,5,12,0,0,92,100,3,20,10,0,
        93,94,10,3,0,0,94,95,5,13,0,0,95,100,3,20,10,0,96,97,10,2,0,0,97,
        98,5,28,0,0,98,100,3,20,10,0,99,90,1,0,0,0,99,93,1,0,0,0,99,96,1,
        0,0,0,100,103,1,0,0,0,101,99,1,0,0,0,101,102,1,0,0,0,102,19,1,0,
        0,0,103,101,1,0,0,0,104,105,6,10,-1,0,105,106,3,22,11,0,106,115,
        ...
        0,0,0,134,133,1,0,0,0,135,27,1,0,0,0,11,37,44,52,69,99,101,113,115,
        125,129,134
    ]
...
class AssignmentStatementParser ( Parser ):
    ...
    ruleNames =  [ "start", "prog", "statement", "ifst", "cond", "assign", 
                   "compoundst", "forst", "whilest", "expr", "term", "factor", 
                   "number", "array" ]
    ...
    def compoundst(self):
        ...
        try:
            ...
            while True:
                ...
                self._errHandler.sync(self)
                _la = self._input.LA(1)
                if not ((((_la) & ~0x3f) == 0 and ((1 << _la) & 2099522) != 0)):
                    break
