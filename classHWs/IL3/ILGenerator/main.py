...
if __name__ == '__main__':
    ...
    argparser.add_argument(
        ...
        # help='Input source', default=r'input4.txt') # for
        # help='Input source', default=r'input5.txt') # while
        # help='Input source', default=r'input6.txt') # all in one
        # help='Input source', default=r'input7.txt') # not equal
        # help='Input source', default=r'input8.txt') # greater than equal, less than equal
        help='Input source', default=r'input9.txt') # greater than equal, less than equal
